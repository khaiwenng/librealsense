...
public:
    ...
    virtual std::string get_subdevice_location() const = 0;
...
public:
    ...
    std::string get_subdevice_location() const override { return _dev->get_subdevice_location(); }
...
public:
    ...
    std::string get_subdevice_location() const override { return _dev.front()->get_subdevice_location(); }
